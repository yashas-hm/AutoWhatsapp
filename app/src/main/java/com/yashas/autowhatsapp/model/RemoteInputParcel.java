...
public class RemoteInputParcel implements Parcelable {
    ...
    public static final Creator CREATOR = new Creator() {
        public com.yashas.autowhatsapp.model.RemoteInputParcel createFromParcel(Parcel in) {
            return new com.yashas.autowhatsapp.model.RemoteInputParcel(in);
        }
        public com.yashas.autowhatsapp.model.RemoteInputParcel[] newArray(int size) {
            return new com.yashas.autowhatsapp.model.RemoteInputParcel[size];
        }
    };
